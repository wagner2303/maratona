...
//Following is C implementation for Matrix Chain Multiplication problem using Dynamic Programming.
...
int MatrixChainOrder(int p[], int n)
{
    ...
    /* m[i,j] = Minimum number of scalar multiplications needed to compute the matrix A[i]A[i+1]...A[j] = A[i..j] where dimention of A[i] is p[i-1] x p[i] */
